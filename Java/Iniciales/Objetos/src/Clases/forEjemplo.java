...
public class forEjemplo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int n = forEjemplo.entrada.nextInt();
        System.out.println("La suma es: "+ forEjemplo.sumarN(n));
        System.out.println("El factorial es: "+ forEjemplo.factorialN(n));
    ...
    public static void clear(){
      ...
      char n = forEjemplo.entrada.next().toLowerCase().charAt(0);
      if (n == 's'){
